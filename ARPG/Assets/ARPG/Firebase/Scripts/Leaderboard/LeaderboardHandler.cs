...
namespace ARPG.Firebase.Leaderboard
{
    /// <summary>
    /// 사용자가 점수를 받을 때 
    /// 수신자에게 알리기 위해 LeaderboardHandler에 사용되는 EventArgs
    /// </summary>
    ...
    public class LeaderboardHandler : MonoBehaviour
    {
        ...
        /// <summary>
        /// Firebase 데이터베이스에 모든 점수를 저장하는 Path입니다.
        /// </summary>
        ...
        private void GetInitialTopScores(long batchEnd)
        {
            ...
            query.GetValueAsync().ContinueWith(task =>
            {
                ...
                // scoresToRetrieve개의 고유 사용자 점수를 찾거나 검색할 점수가 부족해질 때까지
        ...
        private void OnScoreAdded(object sender, ChildChangedEventArgs args)
        {
            ...
            // 동일한 사용자가 이미 더 높은 점수를 가진 경우일 때, 추가하지 않습니다.
        ...
        public void AddScore()
        {
            ...
            AddScore(emailDataList[0], emailDataList[0], playerStats.Exp);
        }
        ...
        public void UpdateUserScore()
        {
            ...
            UpdateScore(emailDataList[0], emailDataList[0], playerStats.Exp + addedScore);
        }
