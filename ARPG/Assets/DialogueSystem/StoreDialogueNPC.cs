...
namespace ARPG.DialogueSystem
{
    public class StoreDialogueNPC : MonoBehaviour, IInteractable
    {
        #region Variables
        ...
        public void Interact(GameObject other)
        {
            ...
            StoreDialogueManager.Instance.OnEndDialogue += OnEndDialogue;
            isStartDialogue = true;

            StoreDialogueManager.Instance.StartDialogue(dialogue);
        }
